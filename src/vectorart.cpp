...
/*
	These SVG assets are the original work of Colin M.L. Burnett.
	Please see the assets/svg directory for more information.
	These SVG assets were extracted for direct use in source code form.
	These SVG assets are distributed under GPLv3.
*/

#include "vectorart.h"


const char *darkKingSVG =
